...
public class AdminController {
	...
	//-------------------------------------------------------
	//게시판 관리 - FAQ - 목록
	@GetMapping("/board/manage/faq/list")
	...
	//게시판 관리 - FAQ - 상세
	@GetMapping("/board/manage/faq/detail")
	...
	//게시판 관리 - FAQ - 수정
	@GetMapping("/board/manage/faq/edit")
	...
	//게시판 관리 - FAQ - 생성
	@GetMapping("/board/manage/faq/create")
	...
	public String noticeList(Model model) {
		model.addAttribute("chNum", new SideBarModel(1, 4));
