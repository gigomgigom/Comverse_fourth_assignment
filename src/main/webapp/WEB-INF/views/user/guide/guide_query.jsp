				...
				<div class="wrap_query">
					<form id="inquiry-form">
								...
								<tr>
									...
									<td>
										<div class="form_group">
											...
											<span id="text_count" class="count"><strong class="current">0자</strong> / 1,000</span>
										</div>
						...
						<div class="btn_center_wrap mb100">
							...
							<a href="javascript:submitInquiryForm(0)" class="btn_regi">등록</a><!-- 190426 javascript:void(0) 추가 -->
						</div>
					</form>
				</div>
			</div>
