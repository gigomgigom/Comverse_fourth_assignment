					...
					<div class="row mb-2">
						<div class="col-sm-12">
							<ol class="breadcrumb float-sm-left pl-5 pt-4">
								...
								<li class="breadcrumb-item active">홈런학습센터 교사후기</li>
							</ol>
						</div>
						<div class="col-sm-12 pl-5 pt-4">
							<h1>홈런학습센터 교사후기 - 목록</h1>
						</div>
					</div>
				</div>
				<!-- /.container-fluid -->
							...
							<form>
					            ...
					            <div class="form-group row">
					                ...
					                <div class="col-sm-10 pt-1">
					                    <input id="status1" type="radio" name="">
					                    ...
					                    <input id="status4" type="radio" name="">
					                    <label for="status4" class="mr-3">상시노출</label>
					                    <input id="status5" type="radio" name="">
					            ...
					            <div class="form-group row">
					                ...
					                <div class="col-sm-10">
					                   ...
					                   <input id="other1" type="checkbox" name="">
					                   <label for="other1" class="mr-3">첨부파일 있음</label>
					                   <input id="other1" type="checkbox" name="">
					                   <label for="other1">댓글 있음</label>
					                </div>
					            </div>
			...
			<section class="content">
				<div class="container-fluid px-3">
					<div class="d-flex justify-content-between row">
						<div class="col-md-5">
							<a href="/admin/board/manage/teacher-review/create" class="btn btn-md btn-outline-primary bg-white">신규 등록</a>
						</div>
							...
							<table class="table">
								...
								<tbody>
									<tr>
										...
										<td class="text-center"><a href="/admin/board/manage/teacher-review/detail">레이아웃 잡는거 초반만 힘들지. 후는 괜찮다.</a></td>
