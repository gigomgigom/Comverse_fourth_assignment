				...
				<div class="card card-default">
					...
					<div class="card-footer bg-white py-5">
						<div class="d-flex justify-content-center">
							<a href="/admin/board/manage/teacher-review/detail" class="btn btn-lg btn-primary mr-5 px-4">저장</a>
						</div>
						<div class="d-flex justify-content-end">
							<a href="/admin/board/manage/teacher-review/detail" class="btn btn-lg btn-outline-danger mr-5 px-4">취소</a>
							<a href="/admin/board/manage/teacher-review/list" class="btn btn-lg btn-outline-secondary px-4">목록</a>
						</div>
					</div>
				</div>
			</section>
