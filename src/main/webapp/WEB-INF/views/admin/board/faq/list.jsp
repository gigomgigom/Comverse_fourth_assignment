			...
			<section class="content">
				<div class="container-fluid px-3">
					<div class="d-flex justify-content-between row">
						<div class="col-md-5">
							<a href="/admin/board/manage/faq/create" class="btn btn-md btn-outline-primary bg-white">신규 등록</a>
						</div>
							...
							<table class="table">
								...
								<tbody>
									<tr>
										...
										<td class="text-center"><a href="/admin/board/manage/faq/detail">레이아웃 잡는거 초반만 힘들지. 후는 괜찮다.</a></td>
