					...
					<div class="row mb-2">
						<div class="col-sm-12">
							<ol class="breadcrumb float-sm-left pl-5 pt-4">
								...
								<li class="breadcrumb-item active">홈런학습센터 학습후기</li>
							</ol>
						</div>
						<div class="col-sm-12 pl-5 pt-4">
							<h1>홈런학습센터 학습후기 - 목록</h1>
						</div>
					</div>
				</div>
				<!-- /.container-fluid -->
			...
			<section class="content">
				<div class="container-fluid px-3">
					<div class="d-flex justify-content-between row">
						<div class="col-md-5">
							<a href="/admin/board/manage/study-review/create" class="btn btn-md btn-outline-primary bg-white">신규 등록</a>
						</div>
							...
							<table class="table">
								...
								<tbody>
									<tr>
										...
										<td class="text-center"><a href="/admin/board/manage/study-review/detail">레이아웃 잡는거 초반만 힘들지. 후는 괜찮다.</a></td>
