			...
			<section class="content">
				<div class="container-fluid px-3">
					<div class="d-flex justify-content-between row">
						<div class="col-md-5">
							<a href="/admin/manage/location/create" class="btn btn-md btn-outline-primary bg-white">신규 등록</a>
						</div>
							...
							<table class="table">
								...
								<tbody>
									<tr>
										...
										<td class="text-center"><a href="/admin/manage/location/detail">강북/경기북부</a></td>
										<td class="text-center">02-1234-5678</td>
										<td class="text-center">2024.09.10</td>
										<td class="text-center">활성</td>
									</tr>
								</tbody>
							</table>
						</div>
