$(document).ready(function () {
    ...
    function validateData() {
		const brId = $('#create-form [name=brId]').val();
		const location = $('#create-form [name=location]').val();
		const exposeStart = $('#create-form [name=exposeStart]').val();
		const exposeEnd = $('#create-form [name=exposeEnd]').val();
	...
	function submitData() {
		...
		$.ajax({
			url: '/admin/manage/general/biz/create-biz',
			type: 'POST',
